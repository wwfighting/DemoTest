...
public class EventPayActivity extends AppCompatActivity {
    ...
    private static final String TAG = "EventPayActivity";
    ...
    BCCallback bcCallback = new BCCallback() {
        ...
        public void done(final BCResult bcResult) {
            ...
            EventPayActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    ...
                    */
                    ...
                    if (result.equals(BCPayResult.RESULT_SUCCESS)) {
                        ...
                        Toast.makeText(EventPayActivity.this, "取消支付！", Toast.LENGTH_LONG).show();
                        ...
                        //Toast.makeText(EventPayActivity.this, toastMsg, Toast.LENGTH_LONG).show();
                        Log.e(TAG, toastMsg);
                        ...
                        //可能出现在支付宝8000返回状态
                        Toast.makeText(EventPayActivity.this, "订单状态未知", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(EventPayActivity.this, "invalid return", Toast.LENGTH_LONG).show();
                    }
    ...
    private Handler mHandler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                final MaterialDialog builder = new MaterialDialog(EventPayActivity.this);
                builder.setTitle("提示");
                builder.setMessage("完成支付需要安装或者升级银联支付控件，是否安装？");
                builder.setPositiveButton("确定", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        UPPayAssistEx.installUPPayPlugin(EventPayActivity.this);
                        builder.dismiss();
                    }
                });
    ...
    private void initViews(){
        ...
        manager = new LinearLayoutManager(EventPayActivity.this, LinearLayoutManager.VERTICAL, false);
        mrvType.setLayoutManager(manager);
        mAdapter = new PayTypeAdapter(EventPayActivity.this);
    ...
    private void initWechatPay(){
        ...
        String initInfo = BCPay.initWechatPay(EventPayActivity.this, "wxe822c67255912a6e");
        if (initInfo != null) {
    ...
    private void useWechatPay(){
        ...
        if (BCPay.isWXAppInstalledAndSupported() &&
            ...
            BCPay.getInstance(EventPayActivity.this).reqWXPaymentAsync(
                    "家瓦商城:" + ordNum,               //订单标题
                    payMoney,                           //订单金额(分)
                    ordNum + "",  //订单流水号
            ...
            Toast.makeText(EventPayActivity.this,
    ...
    private void useUnionPay(){
        ...
        BCPay.getInstance(EventPayActivity.this).reqPaymentAsync(payParam,
                bcCallback);
    }
        ...
        HttpUtil.postAsyn(Constants.BASE_URL + "save_bill.php", new HttpUtil.ResultCallback<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (info.getCode().equals("200")) {
                    ...
                    Toast.makeText(EventPayActivity.this, info.getInfo(), Toast.LENGTH_LONG).show();
                }
            }
        }, new HttpUtil.Param[]{
    ...
    private void eventRequest(){
        HttpUtil.postAsyn(Constants.BASE_URL + "onebuy_event.php", new HttpUtil.ResultCallback<String>() {
            @Override
            public void onError(Request request, Exception e) {
            ...
            public void onResponse(String response) {
                ...
                if (info.getCode().equals("200")) {
                    ...
                    Toast.makeText(EventPayActivity.this, "抢购礼券成功！去 '我的礼券' 查询礼券", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(EventPayActivity.this, CommitOrderActivity.class);
