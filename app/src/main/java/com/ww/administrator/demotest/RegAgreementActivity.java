 ...
 */
public class RegAgreementActivity extends AppCompatActivity {
    ...
    private void loadDatas() {
        mwvShow.loadUrl("file:///android_asset/localhtml/register_agreement.html");
    }
