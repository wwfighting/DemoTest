 ...
 */
public class CouponsNoFragment extends BaseFragment{
    ...
    private void loadDatas() {
        HttpUtil.postAsyn(Constants.BASE_URL + "get_coupons_list.php", new HttpUtil.ResultCallback<String>() {
            @Override
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (strCode.equals("200")) {
                        CouponsResultInfo info = mGson.fromJson(response, CouponsResultInfo.class);
                        if (info.getCode().equals("200")) {
                            mtvOrderNo.setVisibility(View.GONE);
                            mrvOrder.setVisibility(View.VISIBLE);
                            mAdapter = new CouponsFragmentAdapter(getActivity(), info);
